...
# ============================================================================
# Baltic DNS - Скрипт диагностики системы
# ============================================================================
# 
# Этот скрипт проводит комплексную диагностику работоспособности
# системы Baltic DNS и предоставляет детальный отчет
#
# Использование:
...
print_header() {
    echo -e "${BOLD}${BLUE}"
    echo "============================================================================"
    echo "🔍 Baltic DNS - Диагностика системы"
    echo "============================================================================"
    echo -e "${NC}"
...
init_report() {
    cat > "$REPORT_FILE" << EOF
Baltic DNS - Диагностический отчет
=================================
...
main() {
    ...
    if [[ ! -f "docker-compose.yml" ]]; then
        echo -e "${RED}❌ Ошибка: Запустите скрипт из корневой директории Baltic DNS${NC}"
        exit 1
    fi
