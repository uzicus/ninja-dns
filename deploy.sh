...
# ============================================================================
# Baltic DNS - Скрипт автоматического развертывания
# ============================================================================
# 
# Этот скрипт позволяет быстро развернуть Baltic DNS на новом сервере
...
print_header() {
    echo -e "${BOLD}${BLUE}"
    echo "============================================================================"
    echo "🌊 Baltic DNS - Автоматическое развертывание"
    echo "============================================================================"
    echo -e "${NC}"
}
...
check_ports() {
    ...
    if [[ ${#busy_ports[@]} -gt 0 ]]; then
        ...
        echo "Убедитесь что эти службы можно остановить или они совместимы с Baltic DNS"
